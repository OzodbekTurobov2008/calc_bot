...
async def start_command(message:Message):
    ...
    try:
        ...
        await message.answer(text="Bot ishga tushdi")
    except:
        await message.answer(text="Boting endi ishlaydi")
...
async def xabar(message: Message):
    await message.answer("Botingiz ishlayabdi bironta ma'lumot kiriting")
